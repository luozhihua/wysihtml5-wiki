...
<pre><code>var editor = new wyishtml5.Editor("textarea-id");
var onChange = function() { alert("The content of the editor has changed"); };
var onLoad = function() { alert("Go!"); };
// observe
editor.on("change", onChange);
editor.on("load", onLoad);
// unobserve
editor.stopObserving("onChange", onChange);
editor.stopObserving("onChange", onLoad);
</code></pre>
