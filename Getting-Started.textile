...
Either use one of the "existing parser rules set":https://github.com/xing/wysihtml5/tree/master/parser_rules or create your own.
...
<pre><code><form><textarea id="wysihtml5-textarea"></textarea></form></code></pre>
...
The toolbar contains the formatting options. Make sure the toolbar element has an id and is hidden.
