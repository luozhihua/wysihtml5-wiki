...
```
Make sure you place the <code><script></code> at the end of the document, before the <code></body></code> tag because the document must be loaded before running the script.
