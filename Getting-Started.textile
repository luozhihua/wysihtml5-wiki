...
See the "advanced demo":https://github.com/xing/wysihtml5/blob/master/examples/advanced.html. You can add these classes with the "stylesheets - configuration option":https://github.com/xing/wysihtml5/wiki/Configuration (when you initialize wysihtml5, see above), i.e.
