...
Besides the "well advertised feature set":https://github.com/xing/wysihtml5/#readme wysihtml5 offers some hidden gems that might be useful to developers (this is an incomplete list).
